...
namespace RovioLib
{
    ...
    public class RovioController
    {
        ...
        /// </summary>
        /// <returns></returns>
        public string ActivateIRDetector()
        {
            return rwc.Request("rev.cgi?Cmd=nav&action=19&IR=1");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public string DeactivateIRDetector()
        {
            return rwc.Request("rev.cgi?Cmd=nav&action=19&IR=0");
        }
